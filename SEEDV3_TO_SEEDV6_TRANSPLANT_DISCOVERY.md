...
- **Revision 5:** WS1–WS7 now provide exact-search/oracle, draw/history, UCI/process, fake-clock, node-limit, lifecycle-race, rich-evaluation, SEE and TT coverage. Ordering, qsearch and later selective-search tests remain future workstream dependencies.
