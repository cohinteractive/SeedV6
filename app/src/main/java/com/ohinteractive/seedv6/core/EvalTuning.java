...
/**
 * Immutable, validated evaluation data adapted from the SeedV3 tuning resources.
 *
 * <p>The donor properties contained 27,511 keyed values. Only the 27,186 values
 * used by the production evaluator are retained here: 125 material values,
 * 19,200 colour-mirrored piece-square values, and 7,861 criteria values. The
 * inactive KING_ENDGAME_DISTANCE table is deliberately omitted. Compact blobs
 * keep the transplanted data exact without retaining the donor's permissive
 * log-and-continue property loader.</p>
 */
final class EvalTuning {
    ...
    static final EvalTuning INSTANCE = new EvalTuning();
