...
public class GenLegal {
    ...
    private static int generate(long board0, long board1, long board2, long board3, int status, long suppliedCheckers, boolean useSuppliedCheckers, long[] moves, int generationType) {
        ...
        final long checkers = useSuppliedCheckers
            ? suppliedCheckers
            : Board.getCheckers(board0, board1, board2, board3, colorMask, player, kingSquare, allOccupancy);
        ...
        final long rookBlockers = Magic.rookMoves(kingSquare, allOccupancy) & playerOccupancy;
        final long bishopBlockers = Magic.bishopMoves(kingSquare, allOccupancy) & playerOccupancy;
        final long rookPinners = Magic.rookMoves(kingSquare, allOccupancy ^ rookBlockers) & (otherQueens | otherRooks);
        final long bishopPinners = Magic.bishopMoves(kingSquare, allOccupancy ^ bishopBlockers) & (otherQueens | otherBishops);
        long pinned = 0L;
    ...
    private static int getQueenMoves(
        ...
        while(pieceBitboard != 0L) {
            ...
            long moveBitboard = Magic.queenMoves(square, allOccupancy) & responseMask;
    ...
    private static int getRookMoves(
        ...
        while(pieceBitboard != 0L) {
            ...
            pieceBitboard ^= b;
            final int square = bitScan(b);
            long moveBitboard = Magic.rookMoves(square, allOccupancy) & responseMask;
    ...
    private static int getBishopMoves(
        ...
        while(pieceBitboard != 0L) {
            ...
            pieceBitboard ^= b;
            final int square = bitScan(b);
            long moveBitboard = Magic.bishopMoves(square, allOccupancy) & responseMask;
    ...
    private static boolean isSquareAttacked(
        ...
        if((Magic.rookMoves(square, allOccupancy) & (otherQueens | otherRooks)) != 0L) return true;
        return (Magic.bishopMoves(square, allOccupancy) & (otherQueens | otherBishops)) != 0L;
    }
