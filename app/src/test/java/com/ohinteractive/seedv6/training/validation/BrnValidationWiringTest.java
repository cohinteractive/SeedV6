...
class BrnValidationWiringTest {
    @Test void realArenaUsesDistinctPinnedBrnValuesForBothColoursAndNeverFallsBack() {
        double[] weights = new double[BrnFeatureSchema.PARAMETER_COUNT]; weights[0] = .01;
        var candidate = new NetworkModel.Brn(new BrnModel(weights));
        var incumbent = new NetworkModel.Brn(new BrnModel());
