...
class Brn1SearchIntegrationTest {
    ...
    @Test void evaluatorUsesRawSideToMoveValueWithPrivateScratchAndPinnedModel() {
        double[] weights = new double[Brn1Model.PARAMETER_COUNT];
        weights[Brn1Model.OUTPUT_BIAS] = 0.25;
        Brn1Model model = new Brn1Model(weights);
        SearchEvaluation definition = SearchEvaluation.brn1(model);
